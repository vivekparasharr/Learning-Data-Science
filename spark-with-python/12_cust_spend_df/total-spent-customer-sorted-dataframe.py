...
customersDF = spark.read.schema(customerOrderSchema).csv("file:///Users/vivekparashar/Documents/Code/Big-Data/Spark with Python/12_cust_spend_df/customer-orders.csv")
